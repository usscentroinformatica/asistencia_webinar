...
const SHEET_ID = '1kctyvMFqAkvKIxIiQul3it6cOivNDORK8uEzza2nct4'; // ID de tu hoja
const HOJA_NOMBRE = 'Respuestas de formulario 1'; // Nombre exacto de la hoja

// Orden exacto de las 8 columnas (igual que en la hoja)
// A: Marca temporal | B: NOMBRE COMPLETO | C: CURSO | D: PEAD | E: Déjanos tu opinión | F: SOLICITAR CERTIFICADO... | G: Columna 6 | H: Columna 1
